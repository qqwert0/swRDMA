...
//     val a    = RegInit(DCQCN.a.S(32.W))
//     val rt = RegInit(0.S(32.W))
...
//     val cnp_valid_shift = RegInit(0.U(40.W))
//     val cnp_valid = RegInit(0.U(1.W))
...
//     cnp_valid_shift   := Cat(cnp_valid_shift(38,0),cnp_valid)
...
//                 state                           := sCC_STATE
//             }.elsewhen((Timer - last_time) > T_55us.U){
//                 last_time                       := Timer
//                 state                           := sTime
//             }                 
//         }    
...
//         }         
//         is(sWR_CORE){
//             when(meta_reg.op_code === IB_OPCODE.CNP){
//                 cnp_valid                       := 1.U
//             }.elsewhen(HAVE_DATA(meta_reg.op_code)){
//                 cal_valid                       := 1.U
//             }
//             state                           := sWAIT  
