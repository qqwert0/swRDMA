...
class HeadProcess() extends Module{
	...
	// 	when(meta_wire.op_code === IB_OPCODE.RC_WRITE_FIRST||
	// 		 meta_wire.op_code === IB_OPCODE.RC_WRITE_ONLY||
	// 		 meta_wire.op_code === IB_OPCODE.RC_WRITE_ONLY_WIT_IMD||
	// 		 meta_wire.op_code === IB_OPCODE.RC_READ_REQUEST						
	// 	){  
	// 		pack_class := reth_pack
	// 		pack_head_exceed := reth_exceed
	// 	}.elsewhen(meta_wire.op_code === IB_OPCODE.RC_READ_RESP_FIRST||
	// 		       meta_wire.op_code === IB_OPCODE.RC_READ_RESP_LAST||
	// 		       meta_wire.op_code === IB_OPCODE.RC_READ_RESP_ONLY||
	// 		       meta_wire.op_code === IB_OPCODE.RC_ACK){
