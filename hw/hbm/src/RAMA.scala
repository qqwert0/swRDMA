...
class RAMA(ADDR_WIDTH:Int=33, ID_WIDTH:Int=6, IP_CORE_NAME:String="RAMABlackBox") extends Module{
	...
	val instRama=Module(new RAMABlackBox(ADDR_WIDTH=ADDR_WIDTH, ID_WIDTH=ID_WIDTH, IP_CORE_NAME=IP_CORE_NAME))
...
class RAMABlackBox(ADDR_WIDTH:Int, ID_WIDTH:Int, IP_CORE_NAME: String="RAMABlackBox") extends BlackBox {
